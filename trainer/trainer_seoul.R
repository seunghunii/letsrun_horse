...
###trainer information###
url_trainer <- 'http://race.kra.co.kr/trainer/profileTrainerList.do?Act=10&Sub=1&meet=1'
...
dbGetQuery(con,'delete from trainer_info where region="seoul"')
